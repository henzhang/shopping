...
public class SpuServiceImpl implements SpuService {
    ...
    public void saveGoods(Goods goods) {
        ...
        //增加Sku
        Date date = new Date();
        Category category = categoryMapper.selectByPrimaryKey(spu.getCategory3Id()); // 查询三级分类信息
        Brand brand = brandMapper.selectByPrimaryKey(spu.getBrandId());   // 查询品牌信息
        //获取Sku集合
        ...
        for (Sku sku : skus) {
            ...
            //构建SKU名称，采用SPU+规格值组装
            //如 sku name : 华为 Mate40 5G 手机【支持鸿蒙HarmonyOs】 亮黑色 mate40全网通(8G+256G)+12期免息
